...
export default function GovernmentPublicSectorHeroSection() {
  return (
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start">
          ...
          <h1 className="text-4xl lg:text-[56px] font-bold tracking-tight leading-[1.15] mb-6">
            Govern public-sector operations with authority, evidence and
            accountability built in
          </h1>

          {/* Description */}
          <p className="text-gray-400 text-sm lg:text-base leading-relaxed mb-8 max-w-xl">
            ZoikoSuite connects finance, workforce, legal and commercial
            obligations, vendors, policy controls, approvals and audit evidence
            across agencies, entities, programs and jurisdictions — while
            preserving the systems that already run mission services.
          </p>
        ...
        <div className="relative w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[500px] h-[700px] rounded-[32px] overflow-hidden p-4 flex items-center justify-center">
            <Image
              src="/government/1.png"
              alt="Govern public-sector operations illustration"
              fill
              priority
