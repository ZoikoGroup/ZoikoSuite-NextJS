...
const LADDER_CARDS: LadderCard[] = [
  ...
  },
  {
    ...
    items: ["Energy & Utilities", "Manufacturing", "Organization Type"],
    badge: "● PUBLISHED",
    badgeVariant: "green",
  },
  {
    ...
    badge: "● STATUS-BASED • NOT CERTIFIED",
    badgeVariant: "yellow",
  },
  {
    category: "Public-sector references",
    title: "Not published",
    description:
...
export default function GovernmentEvidenceLadderSection() {
  return (
