...
export default function BookEnterpriseDemoGovernmentSection() {
  const [formData, setFormData] = useState({
    ...
    role: "Finance / CFO",
    entities: "",
    primaryQuestion: "Coexistence with financial management and procurement",
  });
    ...
    <section className="w-full bg-[#0F476A] text-white py-20 px-6 lg:px-12 flex justify-center items-center font-sans">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          {/* Main Heading */}
          <h2 className="text-3xl sm:text-4xl lg:text-[52px] font-bold tracking-tight leading-[1.1] mb-6">
            Bring the obligation whose owner left the role
          </h2>

          {/* Description */}
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-10">
            A retention schedule reassigned but never confirmed. A contract
            option window nobody is tracking. A commitment approved against a
            fund whose delegation limit had changed. We will trace one through
            agency, fund, authority and evidence across your own structure.
          </p>

          {/* Left Footer Disclaimer */}
          <div className="flex items-start gap-4 border-l-2 border-[#C59B3F] pl-4 py-1">
            <p className="text-xs text-gray-400 leading-relaxed">
              No authorization status, certification, accessibility conformity,
              jurisdiction coverage, residency option or compliance outcome is
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl p-8 lg:p-10 text-[#0F172A] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            {/* Row 3: Agencies, entities and programs in scope & Primary question */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">
                  Agencies, entities and programs in scope
                </label>
                <input
                  type="text"
                  name="entities"
