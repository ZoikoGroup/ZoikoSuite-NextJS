...
export default function BookEnterpriseDemoMultiIndustrySection() {
  const [formData, setFormData] = useState({
    ...
    role: "CFO / finance",
    primaryQuestion: "Which sector page fits us",
  });
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[52px] font-bold tracking-tight leading-[1.1] mb-6">
            Come with the sector, or come with the problem
          </h2>

          {/* Description */}
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-10">
            If your sector is one of the seven published, start there. If you
            span several, or none of them fits, the operating challenge is the
            better entry point — and a conversation about which specialist
            systems must stay authoritative is more useful than a sector label
            either way.
          </p>
          ...
          <div className="flex items-start gap-4 border-l-2 border-[#C59B3F] pl-4 py-1">
            <p className="text-xs text-gray-400 leading-relaxed">
              No certification, blanket compliance, jurisdiction coverage,
              capability availability or customer outcome is committed outside
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl p-8 lg:p-10 text-[#0F172A] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            {/* Row 2: Organization & Your sector */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">
                  Organization
