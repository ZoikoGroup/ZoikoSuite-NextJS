...
const AI_RULES: AiRuleList[] = [
  ...
  {
    title: "AI MAY NOT - IN EVERY SECTOR",
      ...
      <div className="max-w-6xl w-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-bold tracking-tight leading-[1.15]">
              One boundary, applied in every sector
            </h2>
          </div>
          ...
          <div className="lg:col-span-5 flex items-start">
            <p className="text-gray-300 text-sm lg:text-base leading-relaxed">
              Each industry page adds its own prohibitions on top of these. None
              of them relaxes what follows.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {AI_RULES.map((column, index) => {
            const isMayNot = column.title.includes("AI MAY NOT");
