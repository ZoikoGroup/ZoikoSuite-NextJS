...
const layers = [
  {
    ...
    description:
      "Actor, entity, market, policy basis, authorization outcome, timestamp.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "Access event",
    description:
      "Who accessed protected customer information, for what recorded purpose, and under which policy.",
  },
  {
    number: "05",
...
export default function EvidenceAndAuditReadinessSection() {
  return (
