...
export default function TelecomOperationsSection() {
  return (
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start">
          ...
          <h1 className="text-4xl lg:text-[56px] font-bold tracking-tight leading-[1.15] mb-6">
            Govern telecom operations beyond the network
          </h1>

          {/* Description */}
          <p className="text-gray-400 text-sm lg:text-base leading-relaxed mb-8 max-w-xl">
            Bring finance, workforce, legal, partner, vendor, compliance,
            evidence and cross-entity operations under one governed control
            layer — while your OSS/BSS and network systems keep doing what they
            do best.
          </p>
        ...
        <div className="relative w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[500px] h-[700px] rounded-[32px] overflow-hidden p-4 flex items-center justify-center">
            <Image
              src="/telecom/1.png"
              alt="Telecommunication & MVNOs Isometric Architecture"
              fill
              priority
