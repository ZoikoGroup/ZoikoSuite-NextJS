      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-bold tracking-tight leading-[1.15] mb-6">
            Bring the agreement whose obligations nobody tracks both ways
          </h2>

          {/* Description */}
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-8">
            A host operator agreement with a notice window approaching and one
            signature obtained. A retention schedule whose owner left. A
            customer-data access nobody recorded a purpose for. We will trace
            one through market, authority, classification and evidence across
            your own footprint.
          </p>
          ...
          <div className="border-l-2 border-[#C59B3F] pl-4 py-1">
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              option, certification, compliance status or network outcome is
        ...
        <div className="lg:col-span-6 bg-white text-[#08222F] rounded-2xl p-8 lg:p-10 shadow-2xl">
          ...
          >
            ...
            {/* Row 2: Organization & Operating model */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-[11px] font-bold uppercase tracking-wider text-gray-600 font-mono">
                  Organization
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  type="text"
                  defaultValue="Coexistence with OSS/BSS"
                  className="w-full bg-white border border-gray-200 rounded-lg px-3.5 py-2.5 text-sm text-gray-800 focus:outline-none focus:border-[#08222F]"
                />
              </div>
            </div>
