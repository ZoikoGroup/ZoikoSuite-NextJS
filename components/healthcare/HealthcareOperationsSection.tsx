...
export default function HealthcareOperationsSection() {
  return (
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start">
          ...
          <h1 className="text-4xl lg:text-[56px] font-bold tracking-tight leading-[1.15] mb-6">
            Govern the business of healthcare around the systems you already
            trust
          </h1>

          {/* Description */}
          <p className="text-gray-400 text-sm lg:text-base leading-relaxed mb-8 max-w-xl">
            Bring finance, workforce, legal, vendor, compliance, evidence and
            authority under one policy-aware operating layer — while keeping
            clinical systems and patient-care workflows in their validated
            systems of record.
          </p>
        ...
        <div className="relative w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[500px] h-[700px] rounded-[32px] overflow-hidden p-4 flex items-center justify-center">
            <Image
              src="/healthcare/1.png"
              alt="Healthcare Operations Isometric Architecture"
              fill
              priority
