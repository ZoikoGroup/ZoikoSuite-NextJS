...
import MobileJurisdictionStatusTable from "./MobileJurisdictionStatusTable";

export default function SixCoverageStatesNeverGreenInferenceSection() {
  return (
    <section className="w-full bg-white text-[#0f172a] py-16 sm:py-20 px-4 sm:px-6 lg:px-20 flex justify-center border-t border-[#ede9df]">
      <div className="max-w-[1240px] w-full flex flex-col">
        ...
        {/* Mobile View: Six Coverage States Table (Strictly hidden on desktop) */}
        <div className="w-full block lg:hidden">
          <MobileJurisdictionStatusTable />
        </div>

        {/* Desktop View: 3D Visual Illustration lt5.png (Strictly desktop only) */}
        <motion.div
        ...
        >
          <Image
            src="/leadership-terms/lt5.png"
            alt="Six coverage states never a green inference illustration"
            width={1240}
            height={680}
            priority
