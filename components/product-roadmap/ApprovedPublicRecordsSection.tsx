...
export default function ApprovedPublicRecordsSection() {
  return (
    <section className="w-full bg-white py-16 lg:py-24 px-6 lg:px-24 font-sans antialiased text-[#0F172A]">
      <div className="max-w-6xl mx-auto flex flex-col space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            <p className="text-sm sm:text-base text-[#64748B] leading-relaxed font-normal">
              List is the default view for clarity and accessibility. The board
              groups by status, never by an arbitrary time horizon. Sorting by
              popularity or hidden priority is not offered.
            </p>
          </motion.div>
        </div>

        {/* Board and List Preview Graphic */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.3 }}
        ...
        >
          <div>
            <img
              src="/product-roadmap/p2.png"
              alt="Roadmap board and list interface showing side-by-side table view and status kanban columns"
