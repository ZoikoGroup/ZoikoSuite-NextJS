...
export default function MultiEntityIntelligenceSection() {
  return (
      ...
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <p className="text-xs sm:text-sm text-[#64748b] max-w-md leading-relaxed">
            A global baseline that cannot accommodate a local exception is not a
            policy — it is a wish. The inheritance model makes both visible.
          </p>
        </div>
        ...
        <div className="w-full rounded-2xl overflow-hidden shadow-2xl border border-[#DBE3E8] bg-[#08222F] mb-12">
          <img
            src="/governed-business-operations/5.png"
            alt="Multi-entity and multi-jurisdiction intelligence view"
        ...
        <div className="flex justify-center w-full">
          ...
          >
            Explore multi-entity and multi-jurisdiction operations
