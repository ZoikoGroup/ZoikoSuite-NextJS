    ...
    <section className="w-full bg-[#08222F] py-16 md:py-24 text-white font-sans flex justify-center items-center px-6 lg:px-12">
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          {/* Main Heading */}
          <h2 className="text-4xl lg:text-[56px] font-bold tracking-tight leading-[1.15] mb-6">
            Governed customer evidence, not testimonial theater
          </h2>

          {/* Description */}
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-8 max-w-xl">
            Every public fact traceable to an approved record, every customer
            asset rights-controlled, and every material outcome showing its
            evidence class, time period and limitations.
          </p>
        ...
        <div className="lg:col-span-6">
          <div className="relative w-full h-[350px] sm:h-[450px] lg:h-[530px] rounded-2xl overflow-hidden">
            <Image
              src="/customer/1.png"
              alt="Governed customer evidence interface illustration"
              fill
              priority
