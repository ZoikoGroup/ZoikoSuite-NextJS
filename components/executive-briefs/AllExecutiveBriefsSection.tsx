...
export default function AllExecutiveBriefsSection() {
  const items = [
    {
      ...
      meta: "Updated Aug 14, 2026 · Public · ~8 min read",
      isGoldBorder: false,
    },
    {
      category: "EXECUTIVE BRIEF",
      ...
      meta: "Updated Aug 30, 2026 · Public · ~6 min read",
      isGoldBorder: true,
    },
    {
      category: "EXECUTIVE BRIEF",
    ...
    {
      category: "EXECUTIVE BRIEF",
      title: "Scoping applicability before a procurement review",
      description:
        "A framework for confirming a policy or control actually applies to your deployment.",
      meta: "Published Jul 18, 2026 · Public",
      isGoldBorder: false,
    },
  ];
