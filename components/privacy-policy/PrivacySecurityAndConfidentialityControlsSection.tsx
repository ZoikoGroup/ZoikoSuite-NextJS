...
export default function PrivacySecurityAndConfidentialityControlsSection() {
  const rows = [
    {
      controlArea: "Access governance",
      publicTreatment: "Role/need-to-know principles, where implemented.",
    },
    {
      controlArea: "Encryption",
      publicTreatment: "Only verified implementation scope; no blanket claims.",
    },
    {
      controlArea: "Logging / evidence",
      publicTreatment: "Privacy-relevant auditability at a high level.",
    },
    {
      controlArea: "Data residency",
      publicTreatment: "Deployment/status qualifiers preserved.",
    },
  ] as const;
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-start">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl lg:text-[32px] font-bold text-[#0b1329] leading-tight tracking-tight">
            Reassurance without security marketing
          </h1>
        </div>
        ...
        <div className="w-full flex flex-col border-t border-[#DCD6C8]">
          ...
          <div className="w-full py-4 px-6 border-b border-[#DCD6C8] grid grid-cols-1 md:grid-cols-12 gap-4 text-xs font-semibold tracking-[0.15em] text-[#0b1329] uppercase">
            <div className="md:col-span-4">Control Area</div>
            <div className="md:col-span-8">Public Treatment</div>
          </div>
