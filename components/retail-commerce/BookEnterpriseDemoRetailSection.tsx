...
export default function BookEnterpriseDemoRetailSection() {
  const [formData, setFormData] = useState({
    ...
    role: "CFO / finance",
    entities: "",
    primaryQuestion: "Coexistence with POS, e-commerce and OMS",
  });
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[48px] font-bold tracking-tight leading-[1.1] mb-6">
            Bring the review whose applicability nobody can state
          </h2>

          {/* Description */}
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-10">
            A payment-page script responsibility marked unknown. A lease notice
            window nobody owns. A marketplace terms change that altered your
            obligations without a review. We will trace one through entity,
            channel, authority and evidence across your own estate.
          </p>
          ...
          <div className="flex items-start gap-4 border-l-2 border-[#C59B3F] pl-4 py-1">
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              option, compliance status, assessment outcome or security
              guarantee is committed outside an approved commercial document.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl p-8 lg:p-10 text-[#0F172A] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            {/* Row 3: Entities, stores and channels in scope & Primary question */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">
                  Entities, stores and channels in scope
                </label>
                <input
                  type="text"
                  name="entities"
