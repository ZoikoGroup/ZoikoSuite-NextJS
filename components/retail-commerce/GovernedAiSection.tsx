...
const AI_RULES: AiRuleList[] = [
  {
    ...
    items: [
      ...
      "Prioritize supplier, contract and lease-date exceptions for review",
  ...
  },
  {
    ...
    bgColor: "bg-[#FDF6F6]",
    items: [
      "Price products or change pricing in any system",
      "Approve refunds, credits or customer remediation",
      "Change inventory, orders or fulfilment",
      "Act on or communicate with customers",
      "Approve, authorize or execute any business action",
      "Determine payment scope, privacy applicability or compliance",
    ],
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-bold tracking-tight leading-[1.15]">
              Bounded assistance, not autonomous commerce
            </h2>
          </div>
          ...
          <div className="lg:col-span-5 flex items-start">
            <p className="text-gray-300 text-sm lg:text-base leading-relaxed">
              The commerce context makes one boundary especially load-bearing:
              nothing AI does may touch a customer, a price or a refund.
            </p>
          </div>
        </div>
