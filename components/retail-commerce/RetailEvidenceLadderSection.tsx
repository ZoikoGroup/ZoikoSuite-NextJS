...
const LADDER_CARDS: LadderCard[] = [
  ...
  },
  {
    ...
    items: ["Manufacturing", "Energy & Utilities", "Financial Service"],
    badge: "● PUBLISHED",
    badgeVariant: "green",
  },
  {
    ...
    badge: "● READINESS - NOT CERTIFIED",
    badgeVariant: "yellow",
  },
  {
    category: "Retail customer proof",
    title: "Not published",
    description:
  ...
  },
  {
    ...
    description:
      "No regulated legal, tax, accounting, audit or privacy-law advice is provided. No PCI, GDPR or other compliance certification, assessment outcome or security guarantee is determined or claimed.",
...
export default function RetailEvidenceLadderSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="lg:col-span-5 flex items-start">
            <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
              Architecture and product proof in place of unverified compliance
              badges.
            </p>
          </div>
        </div>
