...
export default function SolutionsArchitectSection() {
  const [formData, setFormData] = useState({
    ...
    organization: "",
    role: "CIO / CISO",
    primaryQuestion: "Isolation and deployment boundaries",
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            <p className="text-[#93A2B8] text-[15px] leading-relaxed mb-10 max-w-lg">
              Most security questionnaires ask whether a control exists. The
              more useful question is which deployment it applies to, who holds
              the key, and what happens when it fails. Those answers need your
              context, not a generic pack.
            </p>
            ...
            <div className="flex items-start gap-3 border-l border-[#C9B07A] pl-4 max-w-md">
              <p className="text-[12px] text-[#93A2B8] leading-relaxed">
                No certification, attestation, detection guarantee, notification
                window or availability commitment is made outside an approved
                commercial document.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 bg-white text-[#111827] rounded-3xl p-8 lg:p-10 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full h-12 flex items-center justify-center gap-2 rounded-full bg-[#D0AA55] hover:bg-[#C59B3F] text-[#111827] font-semibold text-sm transition-colors shadow-sm cursor-pointer"
                >
