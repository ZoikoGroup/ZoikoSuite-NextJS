...
import MobilePolicyVersionAuthorityView from "./MobilePolicyVersionAuthorityView";

export default function PolicyVersionAuthorityLimitSection() {
  return (
    <section className="w-full bg-[#FAF8F5] text-[#08222F] py-16 sm:py-24 px-4 sm:px-6 lg:px-20 flex justify-center border-t border-[#ede9df]">
      <div className="max-w-[1240px] w-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-end mb-12 sm:mb-14">
          ...
          >
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
              A control record that cannot name its policy version and authority source is not evidence of anything.
            </p>
          </motion.div>
        </div>
        ...
        <div className="hidden lg:block">
          ...
          >
            <div className="relative w-full aspect-[16/8] sm:aspect-[16/7] lg:aspect-[2.2/1]">
              <Image
                src="/cfos/cf5.png"
                alt="Policy version, authority limit, segregation, and exception validation network"
                fill
        ...
        {/* Mobile View: Policy Controls, Delegated Authority & Exception Flow (strictly visible on mobile, hidden on lg desktop) */}
        <div className="block lg:hidden w-full">
          <MobilePolicyVersionAuthorityView />
        </div>
      </div>
    </section>
  );
