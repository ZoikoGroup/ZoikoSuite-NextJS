...
import MobileCloseWorkbench from "./MobileCloseWorkbench";

export default function DependenciesAndEvidenceSection() {
  return (
    <section className="w-full bg-[#FAF8F5] text-[#08222F] py-16 sm:py-24 px-4 sm:px-6 lg:px-20 flex justify-center border-t border-[#ede9df]">
      <div className="max-w-[1240px] w-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-end mb-12 sm:mb-14">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-bold tracking-tight text-[#08222F] leading-tight">
              Dependencies and evidence, not a completion bar
            </h2>
          </motion.div>
          ...
          >
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
              Close readiness is a verifiable chain of dependency, not a set percentage, and the issue is raised if not the period is closed.
            </p>
          </motion.div>
        </div>

        {/* Desktop View: Workflow Diagram Banner Image (strictly hidden on mobile, visible on lg) */}
        <div className="hidden lg:block">
          ...
          >
            <div className="relative w-full aspect-[16/8] sm:aspect-[16/7] lg:aspect-[2.2/1]">
              <Image
                src="/cfos/cf2.png"
                alt="Dependencies and evidence workflow showing close readiness and audit traceability"
                fill
        ...
        {/* Mobile View: Interactive Close Workbench (strictly visible on mobile, hidden on lg desktop) */}
        <div className="block lg:hidden w-full">
          <MobileCloseWorkbench />
        </div>
      </div>
    </section>
  );
