...
export default function EffectiveDatedNoticesOnlyWhereTheyMateriallyChangeExpectationsSection() {
  const rows = [
    {
      field: "Jurisdiction / region",
      requiredValue: "Country, state/province, or regulatory bloc.",
    },
    {
      field: "Feature / use case",
      requiredValue: 'Specific AI capability or class — never "all AI."',
    },
    {
      field: "Effective date",
      requiredValue: "Exact date and version of analysis.",
    },
    {
      field: "Implementation state",
      requiredValue:
        "Implemented; configuration required; legal review; planned; not applicable; unsupported.",
    },
  ] as const;
