...
export default function GovernedIntelligenceSection() {
  const aiMayItems = [
    "Classify and group exceptions for review",
  ...
  const aiMayNotItems = [
    "Approve, authorize or execute any financial action",
    "Post, adjust or reverse a ledger entry",
    "Change source truth or overwrite an authoritative record",
    "Determine accounting treatment or a tax position",
    "Mark a control, close dependency or obligation as satisfied",
    "Substitute for legal, tax, accounting or audit judgment",
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[52px] font-bold tracking-tight leading-[1.15]">
              What AI may and may not do here
            </h2>
          </div>
          ...
          <div className="lg:col-span-5 flex items-end lg:justify-end">
            <p className="text-gray-300 text-base lg:text-lg leading-relaxed max-w-md">
              Stated as two explicit lists rather than a general reassurance.
              The boundary is the product feature.
            </p>
          </div>
        </div>
