      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            {/* Main Heading */}
            <h2 className="text-4xl sm:text-5xl lg:text-[56px] font-bold tracking-tight leading-[1.1] mb-6">
            ...
            <p className="text-[#93A2B8] text-base lg:text-[17px] leading-relaxed mb-10 max-w-xl">
              ZoikoSuite is designed to preserve governance decisions, workflow
              history, document lineage, operational events and integrity
              context as work happens — then connect the relevant proof into
              evidence manifests for audit, compliance, legal, security and
              executive review.
            </p>
          ...
          <div className="lg:col-span-6 flex justify-center lg:justify-end">
            <div className="relative w-full">
              <div className="relative w-full h-[380px] sm:h-[460px] lg:h-[520px] rounded-3xl overflow-hidden">
                <Image
                  src="/evidence/1.png"
                  alt="Evidence that explains what happened compliance illustration"
                  fill
