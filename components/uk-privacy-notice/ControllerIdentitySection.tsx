...
const controllerRows = [
  {
    field: "Controller identity",
    value: "[ Exact Legal-approved entity/entities and role wording. ]",
  },
  {
    field: "Corporate relationship",
    value: "[ Brand/entity relationships from the approved Legal Entity Registry only. ]",
  },
  {
    field: "Address/contact",
    value: "[ Approved public contact details only. ]",
  },
  {
    field: "DPO / privacy lead",
    value: "[ Shown only if Legal has approved a DPO/privacy contact disclosure — never assumed to exist. ]",
  },
  {
    field: "Data processor references",
    value: "ZoikoSuite or customers are labeled controller/processor in a specific context only where approved notice copy supports it.",
  },
];

export default function ControllerIdentitySection() {
  return (
    <section id="controller" className="py-5 sm:py-[26px] flex flex-col gap-4 sm:gap-5 scroll-mt-28">
      {/* Heading */}
      <h2
      ...
      <div className="w-full flex flex-col border-t border-[#DCD6C8]">
        {/* Table Header (Hidden on small mobile screens to prevent awkward vertical stacking) */}
