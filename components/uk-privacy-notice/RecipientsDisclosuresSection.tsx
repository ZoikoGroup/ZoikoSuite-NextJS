...
const recipientRows = [
  {
    ...
    value: "[ Approved category label. ]",
  },
  {
    field: "Purpose/reason",
    value: "[ Approved disclosure reason. ]",
  },
  {
    field: "Subprocessor link",
    value: "Uses the approved Subprocessor List only where relevant — never equates all recipients with subprocessors.",
  },
  {
    field: "Third-party names",
    value: "Vendor names are never added unless approved notice/data-governance records require and authorize them.",
  },
];

export default function RecipientsDisclosuresSection() {
  return (
    <section id="recipients" className="py-5 sm:py-[26px] flex flex-col gap-4 sm:gap-5 border-t border-[#DCD6C8] scroll-mt-28">
      {/* Heading */}
      <h2
