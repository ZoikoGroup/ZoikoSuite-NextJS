...
const scopeRows = [
  {
    ...
    value: "[ Exact services/surfaces from the Service Scope Registry. ]",
  },
  {
    field: "Audience/relationship",
    value: "[ Approved visitor/customer/user/prospect scope, only if applicable to this public notice. ]",
  },
  {
    field: "Geographic scope",
    value: "Applicability is never inferred solely from IP/device location.",
  },
  {
    field: "Relationship to Privacy Policy",
    value: "[ Legal-approved explanation of how this notice supplements or forms part of the wider Privacy Policy. ]",
  },
];

export default function ScopeApplicabilitySection() {
  return (
    <section id="scope" className="py-5 sm:py-[26px] flex flex-col gap-4 sm:gap-5 border-t border-[#DCD6C8] scroll-mt-28">
      {/* Heading */}
      <h2
