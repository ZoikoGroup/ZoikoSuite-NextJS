...
const BOTTOM_CARDS: BottomCard[] = [
  ...
  {
    category: "Insurance customer proof",
    title: "Not published",
    description:
      ...
      <div className="max-w-6xl w-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            {/* Main Heading */}
            <h2 className="text-3xl sm:text-4xl lg:text-[44px] max-w-xl font-bold tracking-tight text-[#0F172A] leading-[1.15]">
                    ...
                    <ul className="flex flex-col gap-1 text-xs text-gray-600">
                      {card.items.map((item, i) => (
                        <li
                          ...
                          className={
                            item === "parent"
                              ? "text-[10px] text-gray-400 uppercase font-mono my-0.5"
                              : ""
                          }
                        >
                          {item}
