...
export default function InsuranceOperationsSection() {
  return (
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-gray-400 text-sm lg:text-base leading-relaxed mb-8 max-w-xl">
            Bring finance, workforce, legal, third-party, compliance
            obligations, evidence and authority under one policy-aware control
            layer — without forcing a core insurance replacement.
          </p>
        ...
        <div className="relative w-full aspect-[4/4] rounded-2xl overflow-hidden">
          <Image
            src="/insurance/1.png"
            alt="Govern insurance operations illustration"
            fill
            priority
