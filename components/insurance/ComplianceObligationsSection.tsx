...
const OBLIGATIONS: ObligationItem[] = [
  {
    id: "01",
    obligationAndBasis: {
      title: "TPA service-level review",
      code: "OBL-2026-0412",
      description:
    ...
    ownershipAndScope: {
      ...
      details: "Insurer UK Ltd. · United Kingdom · commercial lines",
      escalation: "Escalation: Procurement → COO → Board risk committee",
    },
    statusAndEvidence: {
      statusBadge: "BLOCKED",
      badgeVariant: "red",
      ...
      subText: "Completion requires evidence, not a status toggle",
    },
    borderColor: "#8A3B3B",
  },
  {
    id: "02",
    obligationAndBasis: {
      title: "Regulatory correspondence deadline",
      code: "OBL-2026-0455",
      description: "Supervisory information request · response window",
    },
    ownershipAndScope: {
      owner: "Compliance lead",
      details: "Insurer GmbH · Germany · specialty",
      escalation: "Escalation: Compliance → CRO",
    },
    statusAndEvidence: {
      statusBadge: "DUE SOON",
      badgeVariant: "yellow",
      evidenceText: "Evidence: partial",
      subText:
...
export default function ComplianceObligationsSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 items-start">
          ...
          <div className="lg:col-span-5 lg:pt-6 flex items-start">
            <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
              Operational obligations only — contractual commitments,
              outsourcing duties, corporate deadlines, tax filings, workforce
              obligations. Not regulator filing or submission.
            </p>
          </div>
        </div>

        {/* Top Two Obligation Cards */}
                ...
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                  <span
                    className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded border ${
                      item.statusAndEvidence.badgeVariant === "red"
                        ? "bg-[#F9EDED] text-[#5A6D79] border-[#5A6D79]"
