...
export default function BookEnterpriseDemoInsuranceSection() {
  const [formData, setFormData] = useState({
    ...
    role: "CFO / finance",
    entities: "",
    primaryQuestion: "Coexistence with policy, claims and billing",
  });
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-10">
            A TPA agreement whose audit right lapsed. A delegated-authority
            arrangement that renewed without a second signature. A supervisory
            deadline that escalated late because the owner had moved teams. We
            will trace one through context, authority and evidence against your
            own entity and jurisdiction structure.
          </p>
