...
import MobileExpansionCommandCenter from "./MobileExpansionCommandCenter";

export default function ExpansionHeroSection() {
  return (
    <section className="w-full bg-[#08222F] text-white pt-12 lg:pt-20 pb-20 lg:pb-28 px-4 sm:px-6 lg:px-20 flex justify-center">
      <div className="max-w-[1240px] w-full flex flex-col">
        {/* Mobile-Only Breadcrumbs (Strictly hidden on lg desktop) */}
        <div className="lg:hidden flex items-center gap-1.5 text-xs text-[#9ba4b5] mb-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start lg:items-center">
          ...
          >
            ...
            {/* Mobile-Only Elements: Warning Banner & Expansion Console (Strictly hidden on lg desktop) */}
            <div className="w-full block lg:hidden">
              <MobileExpansionCommandCenter />
            </div>
          </motion.div>

          {/* Right Column: Graphic (ex1.png) - Strictly Desktop Only */}
          <motion.div
          ...
          >
            <div className="w-full max-w-[540px] rounded-2xl overflow-hidden shadow-2xl bg-transparent">
              <Image
                src="/expansion/ex1.png"
                alt="Expand operations without losing governance, evidence, or accountability illustration"
                width={800}
                height={800}
                priority
