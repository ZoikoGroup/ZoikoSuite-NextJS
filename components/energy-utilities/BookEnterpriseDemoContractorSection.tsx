...
export default function BookEnterpriseDemoContractorSection() {
  const [formData, setFormData] = useState({
    ...
    role: "COO / operations",
    entities: "",
    primaryQuestion: "Coexistence with operational systems",
  });
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-10">
            A critical contractor with an overdue access review and lapsed
            diligence across five sites. A stage-gate approval nobody can
            reconstruct three years into the price control. A site exception
            that quietly became permanent. We will trace one through site
            context, authority and evidence across your own footprint.
          </p>
          ...
          <div className="flex items-start gap-4 border-l-2 border-[#C59B3F] pl-4 py-1">
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              option, certification, conformance, reliability or safety outcome
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl p-8 lg:p-10 text-[#0F172A] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            {/* Row 3: Entities and sites in scope & Primary question */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">
                  Entities and sites in scope
                </label>
                <input
                  type="text"
                  name="entities"
