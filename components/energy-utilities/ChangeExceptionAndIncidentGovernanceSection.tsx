      ...
      <div className="max-w-6xl w-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="lg:col-span-5 flex items-start">
            <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
              The incident itself is managed in operational systems. What
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 sticky top-8">
            <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl aspect-[12/10] bg-[#08222F]">
              <Image
                src="/energy/5.png"
                alt="Change, exception and incident governance control room"
                fill
                priority
