...
const SYSTEMS: SystemCard[] = [
  ...
  {
    name: "EAM / CMMS",
    ownerText: "Source owner: asset management · observed 13:40",
    status: "CONNECTED",
    statusVariant: "green",
  ...
  {
    name: "CIS / billing",
    ownerText: "Source owner: customer ops · observed 09:40",
    status: "LIMITED",
  ...
  {
    name: "OMS",
    ownerText: "Source owner: control room · not yet observed",
  ...
  {
    name: "AMI / MDMS",
    ownerText: "Source owner: metering",
  ...
  {
    name: "GIS",
    ownerText: "Source owner: network records · observed 11:22",
    status: "CONNECTED",
    statusVariant: "green",
    boxType: "REFERENCE ONLY",
  },
  ...
  {
    name: "SCADA / EMS / DMS / ADMS",
    ownerText: "Source owner: operations technology",
      ...
      <div className="max-w-6xl w-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="lg:col-span-5 flex items-start">
            <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
              Where a capability depends on an external utility system, the
              dependency and the authoritative system are shown rather than
              implied.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {SYSTEMS.map((item, index) => {
            ...
            const isScadaCard = item.name === "SCADA / EMS / DMS / ADMS";
            ...
            return (
              ...
              >
                ...
                <div
                  className={`px-3 py-2 rounded-lg text-[10px] font-mono font-bold tracking-wider border ${innerBoxStyle}`}
                >
                  {item.boxType}
                </div>
              </div>
