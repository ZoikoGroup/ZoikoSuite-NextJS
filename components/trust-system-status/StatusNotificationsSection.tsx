...
export default function StatusNotificationsSection() {
  return (
    <section
      id="notifications"
      className="w-full bg-[#F2F0EB] font-sans py-20 md:py-24 px-6 md:px-14 flex justify-center"
    >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full max-w-[633.16px] flex flex-col justify-start items-start">
            <p className="justify-center text-[#3E5A6B] text-base md:text-lg font-normal font-['Archivo'] leading-7">
              A retention and support-reduction tool, not a lead-capture mechanism. Only
              <br />
              configured, supported channels are shown.
            </p>
          </div>
        </div>
