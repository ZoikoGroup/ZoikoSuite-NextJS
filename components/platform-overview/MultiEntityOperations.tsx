...
export default function MultiEntityOperations() {
  return (
    <section className="w-full bg-[#F7F5F0] text-[#0f172a] py-20 px-6 lg:px-24 flex items-center justify-center">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-12">
            ...
            >
              <p className="text-[#64748b] text-sm sm:text-base leading-relaxed">
                Model organizational scope, ownership, policy inheritance,
                reporting relationships, and local exceptions while preserving
                entity-level evidence.
              </p>
            </motion.div>
          </div>

          {/* Holographic Multi-Entity Showcase Image */}
          <motion.div
          ...
          >
            <img
              src="/platform-overview/3.png"
              alt="Multi-entity organizational hierarchy and governance control overview"
