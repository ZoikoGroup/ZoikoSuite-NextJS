...
export default function Stage06ReviewAuthorizationSection() {
  return (
    <section className="w-full bg-white text-[#0f172a] py-20 px-6 lg:px-24 flex items-center justify-center">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-16">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[48px] font-bold tracking-tight leading-[1.1] text-[#0f172a]">
                Give authorized people the evidence and choices required to
                decide
              </h2>
            </motion.div>
            ...
            >
              <p className="text-[#64748b] text-sm sm:text-base leading-relaxed">
                Only permitted decisions are active. Unavailable choices state
                why. Every decision captures a reason and produces a receipt
                that outlives the confirmation message.
              </p>
            </motion.div>
          </div>
          ...
          >
            <img
              src="/how-it-works/7.png"
              alt="Stage 06 review and authorization illustration showing evidence and choices for authorized decision-makers"
