...
export default function Stage08EvidenceAttributionSection() {
  return (
    <section className="w-full bg-white text-[#0f172a] py-20 px-6 lg:px-24 flex items-center justify-center">
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-16">
            ...
            >
              <p className="text-[#64748b] text-sm sm:text-base leading-relaxed">
                A permitted reviewer should be able to reconstruct the signal,
                context, rules, people, decisions, execution, and outcome —
                without relying on a narrative written after the event.
              </p>
            </motion.div>
          </div>
          ...
          >
            <img
              src="/how-it-works/9.png"
              alt="Stage 08 evidence and attribution illustration showing secure preservation of signals, contexts, rules, and decisions"
