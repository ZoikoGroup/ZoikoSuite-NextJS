...
const OBLIGATIONS: ObligationItem[] = [
  {
    ...
    obligationAndBasis: {
      ...
      code: "OBL-2026-0412",
      description: "Site permit condition · reporting cycle",
    },
    ownershipAndScope: {
      owner: "Site compliance lead — named, not a team alias",
      details: "Plant 04 · Bavaria · Mfg GmbH",
  ...
  },
  {
    id: "02",
    obligationAndBasis: {
      title: "Supplier quality audit commitment",
      code: "OBL-2028-0455",
      description: "Customer contract clause 11.2 · annual cycle",
    },
    ownershipAndScope: {
      owner: "Quality manager",
      details: "Plants 01, 02 · Mfg US Inc.",
      escalation: "Escalation: Quality → group quality → COO",
    },
    statusAndEvidence: {
      statusBadge: "SCHEDULED",
      badgeVariant: "blue",
      evidenceText: "Evidence: audit scheduling and outcome record",
      subText: "The inspection itself is executed and recorded in the QMS",
    },
    borderColor: "#2A6386",
  },
];
...
export default function QualityRegulatoryObligationsSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 items-start">
          ...
          <div className="lg:col-span-5 lg:pt-6 flex items-start">
            <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
              Required reviews, filings, evidence, ownership, source and status
              — without blanket compliance claims and without executing
              inspection.
            </p>
          </div>
        </div>
