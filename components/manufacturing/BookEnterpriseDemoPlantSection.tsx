...
export default function BookEnterpriseDemoPlantSection() {
  const [formData, setFormData] = useState({
    ...
    role: "COO / operations",
    entities: "",
    primaryQuestion: "Coexistence with ERP, MES, PLM, QMS",
  });
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start">
          ...
          <p className="text-gray-300 text-sm lg:text-base leading-relaxed mb-10">
            A single-source supplier with lapsed diligence and a renewal
            approaching. A site exception that has quietly become permanent
            practice. A capital approval that took six weeks to reconstruct. We
            will trace one through site context, authority and evidence across
            your own plant footprint.
          </p>
          ...
          <div className="flex items-start gap-4 border-l-2 border-[#C59B3F] pl-4 py-1">
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              option, certification, conformance or plant-safety outcome is
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl p-8 lg:p-10 text-[#0F172A] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            {/* Row 3: Plants and jurisdictions in scope & Primary question */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-700">
                  Plants and jurisdictions in scope
                </label>
                <input
                  type="text"
                  name="entities"
