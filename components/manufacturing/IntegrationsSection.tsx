...
const SYSTEMS: SystemCard[] = [
  ...
  {
    name: "MES",
    ownerText: "Source owner: plant ops · observed 13:40",
    status: "LIMITED",
  ...
  {
    name: "PLM",
    ownerText: "Source owner: engineering · observed 11:22",
    status: "CONNECTED",
    statusVariant: "green",
    boxType: "REFERENCE ONLY",
  },
  {
    name: "QMS",
    ownerText: "Source owner: quality · observed 12:55",
    status: "CONNECTED",
    statusVariant: "green",
    boxType: "REFERENCE ONLY",
  },
  ...
  {
    name: "EAM",
    ownerText: "Source owner: maintenance",
  ...
  {
    name: "OT / control systems",
    ownerText: "Source owner: plant automation",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {SYSTEMS.map((item, index) => {
            ...
            if (item.boxType === "AUTHORITATIVE") {
              ...
              innerBoxStyle = "bg-[#F9EDED] text-[#8A3B3B] border-[#DFA9A9]";
            }

            // Specific background styling for second last card (OT / control systems) container if needed, or handled via outer classes
            const isSecondLast = index === SYSTEMS.length - 2;
