...
export default function SolutionsArchitectSection() {
  const [formData, setFormData] = useState({
    ...
    organization: "",
    role: "CIO / CISO",
    primaryQuestion: "Which deployment meets our constraint",
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-[44px] font-bold tracking-tight leading-[1.15] mb-6">
              Bring the requirement written as &quot;data must stay in
              country&quot;
            </h2>

            {/* Description Paragraph */}
            <p className="text-[#93A2B8] text-[15px] leading-relaxed mb-10 max-w-lg">
              That sentence resolves into seven separate questions, and usually
              two or three of them turn out to be the hard ones — telemetry,
              support access, or backup geography rather than storage. We will
              work through all seven against your deployment and say which
              cannot be met.
            </p>
            ...
            <div className="flex items-start gap-3 border-l border-[#C9B07A] pl-4 max-w-md">
              <p className="text-[12px] text-[#93A2B8] leading-relaxed">
                No region availability, deployment option, key custody
                eligibility, sovereign capability or jurisdiction coverage is
